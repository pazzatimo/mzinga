    ...
    <>
      ...
      <section className="min-h-screen flex items-center pt-24 pb-16 px-6">
        <div className="max-w-7xl mx-auto w-full">
          ...
          <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl leading-[1.05] max-w-5xl mb-8 text-brand-black">
            {data.heroHeadline}
          </h1>
          <p className="text-lg md:text-xl max-w-2xl text-brand-black/70 leading-relaxed mb-10">
